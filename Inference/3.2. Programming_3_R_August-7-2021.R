...
plot(gender ~ occupation, data = CPS1985, 
  ...
  angle = 45, border = "grey", col = brewer.pal(6, "Pastel2"))
...
barchart(wage ~ occupation, data = media.O, col =  brewer.pal(6, "Set3"))
...
etiquetas <- paste(nombre, " (", porcentaje, "%)", sep = "")
etiquetas


# legend(locator(1), levels(occupation), lty = 1, lwd = 2, col = 2:6, box.col = 0, fill = 2:7)
